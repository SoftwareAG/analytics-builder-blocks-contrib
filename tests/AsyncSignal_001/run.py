...
class PySysTest(AnalyticsBuilderBaseTest):
	...
	def validate(self):
		...
		self.assertGrep("waiter.out", expr='apamax.analyticsbuilder.blocks.AsyncSignal\("Reset",\{\}\)')
		self.assertGrep("waiter.out", expr='apamax.analyticsbuilder.blocks.AsyncSignal\("Reset",\{"a":any\(float,100\)\}\)')
